...
export declare class TransactionsService {
    ...
    constructor(transactionRepository: Repository<Transaction>, gatewayService: GatewayService, idempotencyService: IdempotencyService);
    ...
    updateStatus(id: string, status: TransactionStatus, gatewayResponse?: Record<string, unknown>): Promise<Transaction | null>;
